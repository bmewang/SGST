function y=sigmaNSGSTProjected(N, StructureTensorList, PrincipleDirection, a, b, Rot, Experiment,Stretch)
% Takes function "sigmaNSGST" and projects it corresponding to a given
...
% rate depending on the experiment.
    ...
    sigma = sigmaNSGST(N, StructureTensorList, PrincipleDirection, a, b, FF);
